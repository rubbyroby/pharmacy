...
<html lang="en">
    ...
    <body>
            ...
            <nav class="navbar navbar-expand-lg">                
                <div class="container">
                    <a class="navbar-brand d-flex align-items-center" href="{{url('/Home')}}">
                        ...
                        <img src="import/images/comprimes.png" class="navbar-brand-image img-fluid" alt="Roby pharmacie">
                        ...
                        <ul class="navbar-nav ms-lg-auto">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-light" aria-labelledby="navbarLightDropdownMenuLink">
                                    ...
                                    <li><a class="dropdown-item" href="{{url('/Product-detail')}}">Products Detail</a></li>
                                </ul>
                            </li>
                        </ul>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12 mb-5 mb-lg-0">
                            <h2 class="text-white">Welcome to our pharmacy</h2>
                        ...
                        <div class="col-lg-6 col-12">
                            ...
                            <iframe width="560" height="315" src="https://www.youtube.com/embed/GaIeheB_jaI" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                        </div>
                        </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-12 text-center">
                            <h2 class="mb-lg-5 mb-4">About Roby</h2>
                        </div>

                        <div class="col-lg-5 col-12 me-auto mb-4 mb-lg-0">
                            <h3 class="mb-3">Roby pharmacy History</h3>

                            <p><strong>Since 1984</strong>, Roby is ranked #8 in the top 10 pharmacy in the world. Roby specializes in the specialty store pharmaceutical retail business.</p>

                            <p>Roby pharmacy is 100% safe. Please tell your friends about us. Thank you for visiting.</p>
                        </div>

                        <div class="col-lg-3 col-md-6 col-12 mb-4 mb-lg-0 mb-md-0">
                            <div class="member-block">
                                <div class="member-block-image-wrap">
                                    <img src="import/images/members/me1.jpg" class="member-block-image img-fluid" alt="">
                        ...
                        <div class="col-lg-3 col-md-6 col-12">
                            <div class="member-block">
                                <div class="member-block-image-wrap">
                                    <img src="import/images/members/me2.jpg" class="member-block-image img-fluid" alt="">

                                    <ul class="social-icon">
                                        <li class="social-icon-item">
                                            <a href="https://www.linkedin.com/in/rabab-sadouk-46a1b615b/" class="social-icon-link bi-linkedin"></a>
                                        </li>
                                        <li class="social-icon-item">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="section-bg-image-block">
                                ...
                                <p>Feel free to contact us and know the new products.</p>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-12 text-center mx-auto mb-lg-5 mb-4">
                            <h2><span>Membership</span> at Roby</h2>
                        </div>
                        ...
                        <h4 class="mb-4 pb-lg-2">Please join us!</h4>
                            <form action="" method="POST" class="custom-form membership-form shadow-lg" role="form" enctype="multipart/form-data">
                            @csrf
                            ...
                            {{csrf_field()}}
                                <h4 class="text-white mb-4">Become a member</h4>
                                    ...
                                    <div class="form-floating">
                                    <input type="tel" id="phone" name="tel" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" class="form-control" placeholder="Number phone" required="" >

                                    <label for="floatingInput">Number phone</label>
                                    </div>

                                    <div class="form-floating">
                                    <input name="pass" type="password" id="pass" inputmode="numeric" minlength="8" maxlength="12" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" autocomplete="off" class="form-control" placeholder="Password" required="" >
                                    ...
                                    <div class="form-floating">
                                    <input name="pic" type="file" id="pic" class="form-control" required="" >
                    ...
                    <div class="row">
                            ...
                            <div class="col-lg-4 col-md-8 col-12 order-1 order-lg-0">
                                <div class="custom-block-image-wrap">
                                    <a href="event-detail.html">
                                        <img src="import/images/professional-golf-player.jpg" class="custom-block-image img-fluid" alt="">
                        ...
                        <div class="row custom-block custom-block-bg">
                            ...
                            <div class="col-lg-4 col-md-8 col-12 order-1 order-lg-0">
                                <div class="custom-block-image-wrap">
                                    <a href="event-detail.html">
                                        <img src="import/images/girl-taking-selfie-with-friends-golf-field.jpg" class="custom-block-image img-fluid" alt="">
            ...
            <section class="events-section section-bg section-padding" id="section_4">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-12">
                            <h2 class="mb-lg-3">Upcoming Products</h2>
                        </div>
                        ...
                        <div class="row custom-block mb-3">
                            ...
                            <div class="col-lg-6 col-12 order-3 order-lg-0">
                                <div class="custom-block-info mt-2 mt-lg-0">
                                    <a href="{{url('/product-detail')}}" class="events-title mb-3">AVENE</a>

                                    <p class="mb-0">HYALURON ACTIV B3 Sérum Concentré Repulpant 30 ml</p>
                                    ...
                                    <div class="d-flex flex-wrap border-top mt-4 pt-3">
                                        ...
                                        <div class="d-flex align-items-center ms-lg-auto">
                                            <a href="{{url('/Product-detail')}}" class="btn custom-btn">Buy</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row custom-block custom-block-bg">
                            <div class="col-lg-2 col-md-4 col-12 order-2 order-md-0 order-lg-0">
                                <div class="custom-block-date-wrap d-flex d-lg-block d-md-block align-items-center mt-3 mt-lg-0 mt-md-0">
                                    <h6 class="custom-block-date mb-lg-1 mb-0 me-3 me-lg-0 me-md-0">08</h6>
                                    
                                    <strong class="text-white">Mars 2023</strong>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-8 col-12 order-1 order-lg-0">
                                <div class="custom-block-image-wrap">
                                    <a href="{{url('/product-detail')}}">
                                        <img src="import/images/eucerin.jpg" class="custom-block-image img-fluid" alt="">
                            ...
                            <div class="col-lg-6 col-12 order-3 order-lg-0">
                                <div class="custom-block-info mt-2 mt-lg-0">
                                    <a href="{{url('/product-detail')}}" class="events-title mb-3">EUCERIN</a>

                                    <p class="mb-0">Hyaluron Filler + 3x Effect Soin de Nuit 50 ml</p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-5 col-12">
                            <form action="#" method="post" class="custom-form contact-form" role="form">
                                <h2 class="mb-4 pb-2">Contact Roby</h2>
                            ...
                            <div class="contact-info mt-5">
                                <div class="contact-info-item">
                                    <div class="contact-info-body">
                                        <strong>Morocco, Casablanca</strong>

                                        <p class="mt-2 mb-1">
                                            <a href="tel: 0652734790" class="contact-link">
                                                (212) 
                                                065-273-4790
                                            </a>
                                        </p>
        ...
        <script src="import/js/click-scroll.js"></script>
        <script src="import/js/animated-headline.js"></script>
        <script src="import/js/modernizr.js"></script>
