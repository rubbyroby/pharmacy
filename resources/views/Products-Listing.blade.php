...
<html lang="en">
    <head>
        ...
        <title>Roby pharmacy - Products Listing</title>
                        ...
                        <ul class="navbar-nav ms-lg-auto">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-light" aria-labelledby="navbarLightDropdownMenuLink">
                                    <li><a class="dropdown-item active" href="{{url('/Products-Listing')}}">Products Listing</a></li>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12">
                            ...
                            <h1 class="text-white mb-4 pb-2">Products Listing</h1>

                            <a href="#section_3" class="btn custom-btn smoothscroll me-3">Explore products</a>
                        </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-12">
                            <h2 class="mb-lg-5 mb-4">Latest products</h2>
                        </div>

                        <div class="col-lg-6 col-12 mb-5 mb-lg-0">
                            <div class="custom-block-image-wrap">
                                <a href="{{url('/product-detail')}}">
                                    <img src="import/images/Pure-Vitamin-C-10-Serum_30ml_01_La-Roche-Posay.jpg" class="custom-block-image img-fluid" alt="">
                            ...
                            <div class="custom-block-info">
                                <a href="{{url('/product-detail')}}" class="events-title mb-2">PURE VITAMIN C10 VITAMIN C SERUM</a>

                                <p class="mb-0">Serum with 10% vitamin C with anti-wrinkle action. Reveals the radiance of sensitive skin.</p>
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="custom-block-image-wrap">
                                <a href="{{url('/product-detail')}}">
                                    <img src="import/images/Toleriane-Ultra-Dermallergo-Soothing-Serum_20ml_01_La-Roche-Posay.jpg" class="custom-block-image img-fluid" alt="">
                            ...
                            <div class="custom-block-info">
                                <a href="{{url('/product-detail')}}" class="events-title mb-2">TOLERIANE ULTRA DERMALLERGO SERUM</a>

                                <p class="mb-0">Repairing Hydrating Soothing Serum. Sérum ultra-apaisant testé sur peaux ultra-sensibles ou allergiques</p>
                                <p></p>
            ...
            <section class="events-section events-listing-section section-bg section-padding" id="section_3">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-12">
                            <h2 class="mb-3">Upcoming Products</h2>
                        </div>
                        ...
                        <div class="row custom-block custom-block-bg">
                            ...
                            <div class="col-lg-6 col-12 order-3 order-lg-0">
                                <div class="custom-block-info mt-2 mt-lg-0">
                                    <a href="{{url('/product-detail')}}" class="events-title mb-3">Group tournament activities</a>
